...
var PhraseDetailsComponent2 = (function () {
    function PhraseDetailsComponent2(router, activatedRoute, service) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.service = service;
    }
    PhraseDetailsComponent2.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PhraseDetailsComponent2.prototype.goToPhraseList = function () {
        var pId = this.phrase ? this.phrase.id : null;
        this.router.navigate(['phrases3', { id: pId, param1: "test", param2: 123 }]);
    };
    return PhraseDetailsComponent2;
}());
PhraseDetailsComponent2 = __decorate([
    core_1.Component({
        moduleId: module.id,
...
], PhraseDetailsComponent2);
exports.PhraseDetailsComponent2 = PhraseDetailsComponent2;
